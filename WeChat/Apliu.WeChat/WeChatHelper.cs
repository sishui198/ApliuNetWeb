using Apliu.Standard.WeChat.Modal;
using System;
...
using System.Xml;
using Apliu.Standard.WeChat.Modal.Response;
using Apliu.Standard.WeChat.Modal.Request;
using Newtonsoft.Json.Linq;
using Newtonsoft.Json;
using System.Drawing;

namespace Apliu.Standard.WeChat.Helper
{
    /// <summary>
    ...
    public class WeChatHelper
    {
        ...
        public void Start()
        {
            ...
            {
                factory.StartNew(() => GetLoginQrCodeAsync())
        ...
        public Image GetLoginQrCode()
        {
            ...
            try
            {
                ...
                imgLoginQRCode = httpClient.GetImage(qrcodeUrl);
            }
            catch (Exception e)
            {
                asyncOperation.Post(
            ...
            return imgLoginQRCode;
        }

        /// <summary>
        /// 获取登陆二维码
        /// </summary>
        private void GetLoginQrCodeAsync()
        {
            try
            {
                string jsloginUrl = "https://login.wx.qq.com/jslogin?appid=wx782c26e4c19acffb&redirect_uri=https%3A%2F%2Fwx.qq.com%2Fcgi-bin%2Fmmwebwx-bin%2Fwebwxnewloginpage&fun=new&lang=en_US&_=" + OtherUtils.GetJavaTimeStamp();
