...
namespace Apliu.Database
{
    public abstract class DbContext : IDbContext
    {
        ...
        private static readonly IReadOnlyDictionary<DbType, Type> _dbContextTypes;
        static DbContext()
        {
            var dbTypes = new Dictionary<DbType, Type>();
            ...
            foreach (var filePath in filePaths)
            {
                ...
                foreach (var type in assembly.GetTypes())
                {
                    ...
                    {
                        var dbAttr = type.GetCustomAttribute<DbTypeAttribute>();
                        if (dbAttr != null)
                        {
            ...
            _dbContextTypes = new ReadOnlyDictionary<DbType, Type>(dbTypes);
        }
        ...
        public static IDbContext CreateDbContext(DbType dbType, string ip, string port, string dbName, string userName, string password)
        {
