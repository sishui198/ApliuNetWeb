...
namespace ApliuCoreWeb.Models
{
    ...
    public class DataAccess
    {
        ...
        /// 数据库类型
        /// </summary>
        public DbType DbType => DbHelper.DbSession.DbType;
        ...
        {
            ORM = new ORM(this);
            DbHelper = DbContext.CreateDbContext((DbType)Enum.Parse(typeof(DbType), databaseType), ip, port, dbName, userName, password);
        }
