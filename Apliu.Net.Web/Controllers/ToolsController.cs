...
namespace ApliuCoreWeb.Controllers
{
    ...
    public class ToolsController : ControllerBase
    {
        ...
        public string GetTempContent()
        {
            ...
            string userid = null;// HttpContext.Session.GetUserInfo()?.UserId;
        ...
        public string SetTempContent()
        {
            ...
            string userid = "Everyone";// string.IsNullOrEmpty(HttpContext.Session.GetUserInfo()?.UserId) ? "Everyone" : HttpContext.Session.GetUserInfo()?.UserId;
