...
var Zepto = function () {
    ...
    function h(t) {
        var e, n;
        return D[t] || (e = Z.createElement(t), Z.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), D[t] = n),
        D[t]
    }
    function p(t) {
        return "children" in t ? k.call(t.children) : T.map(t.childNodes,
        function (t) {
    ...
    function w(t, e) {
        e(t);
        for (var n = 0,
        i = t.childNodes.length; i > n; n++) w(t.childNodes[n], e)
    }
    var E, j, T, C, S, O, A = [],
    P = A.concat,
    N = A.filter,
    ...
    Y.fragment = function (t, e, n) {
        var i, r, a;
        return $.test(t) && (i = T(Z.createElement(RegExp.$1))),
        i || (t.replace && (t = t.replace(_, "<$1></$2>")), e === E && (e = L.test(t) && RegExp.$1), e in V || (e = "*"), a = V[e], a.innerHTML = "" + t, i = T.each(k.call(a.childNodes),
        function () {
            a.removeChild(this)
        })),
        o(n) && (r = T(i), T.each(n,
    ...
    Y.init = function (t, n) {
        var i;
        if (!t) return Y.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && L.test(t)) i = Y.fragment(t, RegExp.$1, n),
        t = null;
        else {
            if (n !== E) return T(n).find(t);
            i = Y.qsa(Z, t)
        } else {
            if (e(t)) return T(Z).ready(t);
            if (Y.isZ(t)) return t;
            if (Q(t)) i = s(t);
            else if (r(t)) i = [t],
            t = null;
            else if (L.test(t)) i = Y.fragment(t.trim(), RegExp.$1, n),
            t = null;
            else {
                if (n !== E) return T(n).find(t);
                i = Y.qsa(Z, t)
    ...
    T.contains = Z.documentElement.contains ?
    function (t, e) {
    ...
    T.fn = {
        ...
        ready: function (t) {
            return H.test(Z.readyState) && Z.body ? t(T) : Z.addEventListener("DOMContentLoaded",
            function () {
                t(T)
            },
            !1),
        ...
        filter: function (t) {
            return e(t) ? this.not(this.not(t)) : T(N.call(this,
            function (e) {
                return Y.matches(e, t)
            }))
        },
        add: function (t, e) {
            return T(O(this.concat(T(t, e))))
        },
        is: function (t) {
        ...
        not: function (t) {
            ...
            if (e(t) && t.call !== E) this.each(function (e) {
                ...
                var i = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? k.call(t) : T(t);
        ...
        closest: function (t, e) {
            var n = this[0],
            r = !1;
            for ("object" == typeof t && (r = T(t)) ; n && !(r ? r.indexOf(n) >= 0 : Y.matches(n, t)) ;) n = n !== e && !i(n) && n.parentNode;
            return T(n)
        },
        parents: function (t) {
        ...
        attr: function (t, e) {
            ...
            return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                if (1 === this.nodeType) if (r(t)) for (j in t) y(this, j, t[j]);
        ...
        offset: function (t) {
            ...
            if (!T.contains(Z.documentElement, this[0])) return {
                top: 0,
                left: 0
            };
        ...
        removeClass: function (t) {
            return this.each(function (e) {
                if ("className" in this) {
                    ...
                    C = b(this),
                    g(this, t, e, C).split(/\s+/g).forEach(function (t) {
                        C = C.replace(l(t), " ")
                    }),
                    b(this, C.trim())
                }
        ...
        offsetParent: function () {
            return this.map(function () {
                for (var t = this.offsetParent || Z.body; t && !q.test(t.nodeName) && "static" == T(t).css("position") ;) t = t.offsetParent;
                return t
            })
        }
    },
    ...
    W.forEach(function (e, n) {
        ...
        T.fn[e] = function () {
            ...
            return o.length < 1 ? this : this.each(function (t, e) {
                ...
                var s = T.contains(Z.documentElement, r);
...
function (t) {
    ...
    function l(t) {
        ...
        t && (t == j ? "html" : t == E ? "json" : x.test(t) ? "script" : w.test(t) && "xml") || "text"
    }
    function f(t, e) {
    ...
    t.ajax = function (e) {
        ...
        var d = u.dataType,
        g = /\?.+=\?/.test(u.url);
        if (g && (d = "jsonp"), u.cache !== !1 && (e && e.cache === !0 || "script" != d && "jsonp" != d) || (u.url = f(u.url, "_=" + Date.now())), "jsonp" == d) return g || (u.url = f(u.url, u.jsonp ? u.jsonp + "=?" : u.jsonp === !1 ? "" : "callback=?")),
        t.ajaxJSONP(u, p);
        var b, x = u.accepts[d],
        w = {},
        E = function (t, e) {
        ...
        if (p && p.promise(S), u.crossDomain || E("X-Requested-With", "XMLHttpRequest"), E("Accept", x || "*/*"), (x = u.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(x)), (u.contentType || u.contentType !== !1 && u.data && "GET" != u.type.toUpperCase()) && E("Content-Type", u.contentType || "application/x-www-form-urlencoded"), u.headers) for (v in u.headers) E(v, u.headers[v]);
        ...
        o(S, u) === !1) return S.abort(),
        s(null, "abort", S, u, p),
        S;
        if (u.xhrFields) for (v in u.xhrFields) S[v] = u.xhrFields[v];
        var A = "async" in u ? u.async : !0;
        S.open(u.type, u.url, A, u.username, u.password);
        for (v in w) O.apply(S, w[v]);
        return u.timeout > 0 && (b = setTimeout(function () {
            S.onreadystatechange = c,
            S.abort(),
            s(null, "timeout", S, u, p)
        },
        u.timeout)),
    ...
    t.Callbacks = function (e) {
        ...
        f = {
            ...
            fireWith: function (t, e) {
                return !u || i && !c || (e = e || [], e = [t, e.slice ? e.slice() : e], r ? c.push(e) : l(e)),
                this
            },
            fire: function () {
...
function (t) {
    function e(t, e) {
        ...
        T = !x && t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
        C = T || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/); (i.webkit = !!r) && (i.version = r[1]),
        ...
        w && (i.firefox = !0, i.version = w[1]),
        E && (n.firefoxos = !0, n.version = E[1]),
        j && (i.ie = !0, i.version = j[1]),
        C && (a || n.ios || f) && (i.safari = !0, n.ios || (i.version = C[1])),
        T && (i.webview = !0),
        n.tablet = !!(s || b || o && !t.match(/Mobile/) || w && t.match(/Tablet/) || j && !t.match(/Phone/) && t.match(/Touch/)),
        n.phone = !(n.tablet || n.ipod || !(o || c || l || v || g || x && t.match(/Android/) || x && t.match(/CriOS\/([\d.]+)/) || w && t.match(/Mobile/) || j && t.match(/Touch/)))
    }
...
function (t, e) {
    ...
    t.fn.anim = function (i, r, d, m, v) {
        ...
        S = !1;
        if (r === e && (r = t.fx.speeds._default / 1e3), v === e && (v = 0), t.fx.off && (r = 0), "string" == typeof i) E[l] = i,
        E[f] = r + "s",
        E[p] = v + "s",
        E[h] = d || "linear",
        C = t.fx.animationEnd;
            ...
            x = [];
            for (b in i) g.test(b) ? j += b + "(" + i[b] + ") " : (E[b] = i[b], x.push(n(b)));
            j && (E[o] = j, x.push(o)),
            r > 0 && "object" == typeof i && (E[a] = x.join(", "), E[s] = r + "s", E[c] = v + "s", E[u] = d || "linear")
        }
        return w = function (e) {
...
function (t) {
    ...
    i.qsa = function (e, o) {
        ...
        function (n, a, s) {
            try {
                var l; !n && a ? n = "*" : u.test(n) && (l = t(e).addClass(c), n = "." + c + " " + n);
                var f = r(e, n)
            } catch (h) {
