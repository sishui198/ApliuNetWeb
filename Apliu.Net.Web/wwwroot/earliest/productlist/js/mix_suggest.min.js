var mix_Suggest=function(a){that=this;that.opt=a||{};that.operator=that.opt.operator||".keyword";that.ajaxUrl=that.opt.ajaxUrl||"/api/tools/apliuajax";that.mix_initInput()};
