(function (b) {
    var f = {
        ...
        lazyLoadInit: function () {
            ...
            window.onscroll = function () {
                var brecprdswrapper = b(".rec-prds-wrapper").offset();
                var btop = 0;
                if (brecprdswrapper != null) btop = brecprdswrapper.top;

                f.goTop();
                b(".lazy").each(function () {
                    a.images(b(this))
                });
                0 == b(".rec-prds").length && !0 != b(".rec-prds-wrapper").data("lazyLoad") && b(window).scrollTop() + window.innerHeight > btop - 150 && (b(".rec-prds-wrapper").data("lazyLoad", !0),
                    a.recPrdsInit())
            }
        },
        recPrdsInit: function () {
            this.recPrdsWrapperTpl = '<h2 class="title">推荐</h2><div class="rec-prds"><ul></ul></div>';
        ...
        recPrdsScroller: function () {
            ...
            rec_prds_scroller.on("scrollEnd",
                function () {
                    rec_prds.currentPage = Math.ceil(this.x / -rec_prds.pageWidth) + 1;
                    this.x > this.startX ? (!0 == b('.rec-prds li[data-page-nubmer="' + rec_prds.currentPage + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage, rec_prds.pageSize, "destroyed"), 1 != rec_prds.currentPage && 0 == b('[data-page-nubmer="' + (rec_prds.currentPage - 1) + '"]').length && a.loadRecPrds(rec_prds.currentPage - 1, rec_prds.pageSize, "destroyed"), !0 == b('.rec-prds li[data-page-nubmer="' + (rec_prds.currentPage - 1) + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage - 1, rec_prds.pageSize, "destroyed"), !0 == b('.rec-prds li[data-page-nubmer="' + (rec_prds.currentPage - 2) + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage - 2, rec_prds.pageSize, "destroyed"), !0 == b('.rec-prds li[data-page-nubmer="' + (rec_prds.currentPage - 3) + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage - 3, rec_prds.pageSize, "destroyed")) : (0 == b('[data-page-nubmer="' + (rec_prds.currentPage + 1) + '"]').length && a.moreRecPrds(rec_prds.currentPage + 1, rec_prds.pageSize), !0 == b('.rec-prds li[data-page-nubmer="' + rec_prds.currentPage + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage, rec_prds.pageSize, "destroyed"), 1 != rec_prds.currentPage && 0 == b('[data-page-nubmer="' + (rec_prds.currentPage - 1) + '"]').length && a.loadRecPrds(rec_prds.currentPage - 1, rec_prds.pageSize, "insert"), b('[data-page-nubmer="' + (rec_prds.currentPage - 4) + '"]').html("").data("destroyed", !0), !0 == b('.rec-prds li[data-page-nubmer="' + rec_prds.currentPage + '"]').data("destroyed") && a.loadRecPrds(rec_prds.currentPage, rec_prds.pageSize, "destroyed"))
                })
        },
        loadRecPrds: function (a, c, e) {
            var d = this,
                f = "";
            window.recUnlock && (window.recUnlock = !1, null)
        },
    ...
    b(document).ready(function () {
        ...
        window.submit_search = function () {
            if (b("#keyword").val() == "" || b("#keyword").val() == "请输入搜索内容") return false;
            else return false;
        }
    });
